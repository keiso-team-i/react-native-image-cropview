...
const Overlay = ({ top, bottom, right, left, rounded, containerWidth, containerHeight, backdropOpacity, minCropperBoxSize, }) => {
    ...
    const minCropSize = Math.min(minCropperBoxSize.width, minCropperBoxSize.height);
